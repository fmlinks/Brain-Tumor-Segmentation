...
class FPN0:
    ...
    def train(self):
        ...
        checkpointer = ModelCheckpoint(filepath='../weights/PA+FP+ED/0/PAUnet_test.{epoch:02d}-{val_loss:.2f}.hdf5',
        ...
        with open('../weights/PA+FP+ED/0/dunet_tfcv5_test.json', 'w') as f:
    ...
    def test(self):
        ...
        model.summary()
        model.load_weights('./weights/dunet_150_5.69-0.03.hdf5')
...
class FPN1:
    ...
    def train(self):
        ...
        model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy', self.dice_comp,
                                                                                  self.dice_core, self.dice_en])
        checkpointer = ModelCheckpoint(filepath='../weights/PA+FP+ED/1/PAUnet.{epoch:02d}-{val_loss:.2f}.hdf5',
                                       monitor='val_loss', verbose=1)
...
class FPN2:
    ...
    def train(self):
        ...
        model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy', self.dice_comp,
                                                                                  self.dice_core, self.dice_en])
        checkpointer = ModelCheckpoint(filepath='../weights/PA+FP+ED/2/PAUnet.{epoch:02d}-{val_loss:.2f}.hdf5',
                                       monitor='val_loss', verbose=1)
...
class FPN3:
    ...
    def train(self):
        ...
        model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy', self.dice_comp,
                                                                                  self.dice_core, self.dice_en])
        checkpointer = ModelCheckpoint(filepath='../weights/PA+FP+ED/3/PAUnet.{epoch:02d}-{val_loss:.2f}.hdf5',
                                       monitor='val_loss', verbose=1)
...
class FPN4:
    ...
    def train(self):
        ...
        model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy', self.dice_comp,
                                                                                  self.dice_core, self.dice_en])
        checkpointer = ModelCheckpoint(filepath='../weights/PA+FP+ED/4/PAUnet.{epoch:02d}-{val_loss:.2f}.hdf5',
                                       monitor='val_loss', verbose=1)
