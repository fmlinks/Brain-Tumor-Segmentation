...
class DUnet0():
    ...
    def test(self):
        model = self.conv_block((240, 240, 4), nb_filters=32)
        model.summary()
        model.load_weights('../weights/DUnet/0/dunet_tfcv5.70.hdf5')
        X_train, Y_train, X_test, Y_test = self.load_data('../data/', mode=False)
        ...
        print(pred1.shape)
        np.save('../results/DUnet/0/dunet_tfcv5.npy', pred1)
...
class DUnet1():
    ...
    def test(self):
        model = self.conv_block((240, 240, 4), nb_filters=32)
        model.summary()
        model.load_weights('../weights/DUnet/1/dunet_tfcv5.70.hdf5')
        X_train, Y_train, X_test, Y_test = self.load_data('../data/', mode=False)
        del X_train, Y_train, Y_test
        model.summary()
        print(X_test.shape)
        ...
        print(pred1.shape)
        np.save('../results/DUnet/1/dunet_tfcv5.npy', pred1)
...
class DUnet2():
    ...
    def test(self):
        model = self.conv_block((240, 240, 4), nb_filters=32)
        model.summary()
        model.load_weights('../weights/DUnet/2/dunet_tfcv5.70.hdf5')
        X_train, Y_train, X_test, Y_test = self.load_data('../data/', mode=False)
        del X_train, Y_train, Y_test
        model.summary()
        print(X_test.shape)
        ...
        print(pred1.shape)
        np.save('../results/DUnet/2/dunet_tfcv5.npy', pred1)
...
class DUnet3():
    ...
    def test(self):
        model = self.conv_block((240, 240, 4), nb_filters=32)
        model.summary()
        model.load_weights('../weights/DUnet/3/dunet_tfcv5.70.hdf5')
        X_train, Y_train, X_test, Y_test = self.load_data('../data/', mode=False)
        del X_train, Y_train, Y_test
        model.summary()
        print(X_test.shape)
        ...
        print(pred1.shape)
        np.save('../results/DUnet/3/dunet_tfcv5.npy', pred1)
...
class DUnet4():
    ...
    def test(self):
        model = self.conv_block((240, 240, 4), nb_filters=32)
        model.summary()
        model.load_weights('../weights/DUnet/4/dunet_tfcv5.70.hdf5')
        X_train, Y_train, X_test, Y_test = self.load_data('../data/', mode=False)
        del X_train, Y_train, Y_test
        model.summary()
        print(X_test.shape)
        ...
        print(pred1.shape)
        np.save('../results/DUnet/4/dunet_tfcv5.npy', pred1)
