...
class FPN0:
    ...
    def train(self):
        ...
        checkpointer = ModelCheckpoint(filepath='../weights/PA+EFP+ED/0/PAUnet_test.{epoch:02d}-{val_loss:.2f}.hdf5',
        ...
        with open('../weights/PA+EFP+ED/0/dunet_tfcv5_test.json', 'w') as f:
...
class FPN1:
    ...
    def train(self):
        ...
        model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy', self.dice_comp,
                                                                                  self.dice_core, self.dice_en])
        checkpointer = ModelCheckpoint(filepath='../weights/PA+EFP+ED/1/PAUnet.{epoch:02d}-{val_loss:.2f}.hdf5',
                                       monitor='val_loss', verbose=1)
...
class FPN2:
    ...
    def train(self):
        ...
        model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy', self.dice_comp,
                                                                                  self.dice_core, self.dice_en])
        checkpointer = ModelCheckpoint(filepath='../weights/PA+EFP+ED/2/PAUnet.{epoch:02d}-{val_loss:.2f}.hdf5',
                                       monitor='val_loss', verbose=1)
...
class FPN3:
    ...
    def train(self):
        ...
        model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy', self.dice_comp,
                                                                                  self.dice_core, self.dice_en])
        checkpointer = ModelCheckpoint(filepath='../weights/PA+EFP+ED/3/PAUnet.{epoch:02d}-{val_loss:.2f}.hdf5',
                                       monitor='val_loss', verbose=1)
...
class FPN4:
    ...
    def train(self):
        ...
        model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy', self.dice_comp,
                                                                                  self.dice_core, self.dice_en])
        checkpointer = ModelCheckpoint(filepath='../weights/PA+EFP+ED/4/PAUnet.{epoch:02d}-{val_loss:.2f}.hdf5',
                                       monitor='val_loss', verbose=1)
