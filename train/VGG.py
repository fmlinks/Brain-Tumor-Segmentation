...
class VGG0():
    ...
    def train(self):
        ...
        checkpointer = ModelCheckpoint(filepath='../weights/VGG/0/VGG16_tfcv5.{epoch:02d}-{val_loss:.4f}.hdf5',
                                       monitor='val_loss', verbose=1)
        hist = model.fit(X_train, Y_train, validation_data=(X_test, Y_test), epochs=70, batch_size=10, shuffle=True,
    ...
    def test(self):
        ...
        print(X_test.shape)
        model = self.get_model()
        model.load_weights('./VGG0/weights/VGG16_tfcv5.69-0.0231.hdf5')
        ...
        print(pred1.shape)
        np.save('./VGG0/VGG16_tfcv5_1.npy', pred1)
...
class VGG1():
    ...
    def train(self):
        ...
        model.compile(optimizer=adam, loss='categorical_crossentropy',
                      metrics=['accuracy', self.dice_comp, self.dice_core, self.dice_en])  # adam 0.001 SGD 0.0001 SGD 0.00001
        checkpointer = ModelCheckpoint(filepath='../weights/VGG/1/VGG16_tfcv5.{epoch:02d}-{val_loss:.4f}.hdf5',
                                       monitor='val_loss', verbose=1)
        hist = model.fit(X_train, Y_train, epochs=70, validation_data=(X_test, Y_test), batch_size=10, shuffle=True,
                         callbacks=[checkpointer, change_lr])
    ...
    def test(self):
        ...
        print(X_test.shape)
        model = self.get_model()
        model.load_weights('./VGG1/weights/VGG16_tfcv5.69-0.0231.hdf5')
        pred = model.predict(X_test, batch_size=4, verbose=1)
        ...
        for slices in range(pred.shape[0]):
            ...
            for i in range(pred.shape[1]):
                for j in range(pred.shape[2]):
                    pred1[slices, i, j, 0] = np.argmax(pred[slices, i, j, :])
        print(pred1.shape)
        np.save('./VGG1/VGG16_tfcv5_1.npy', pred1)
...
class VGG2():
    ...
    def train(self):
        ...
        model.compile(optimizer=adam, loss='categorical_crossentropy',
                      metrics=['accuracy', self.dice_comp, self.dice_core, self.dice_en])  # adam 0.001 SGD 0.0001 SGD 0.00001
        checkpointer = ModelCheckpoint(filepath='../weights/VGG/2/VGG16_tfcv5.{epoch:02d}-{val_loss:.4f}.hdf5',
                                       monitor='val_loss', verbose=1)
        hist = model.fit(X_train, Y_train, epochs=70, validation_data=(X_test, Y_test), batch_size=10, shuffle=True,
                         callbacks=[checkpointer, change_lr])
    ...
    def test(self):
        ...
        print(X_test.shape)
        model = self.get_model()
        model.load_weights('./VGG2/weights/VGG16_tfcv5.69-0.0231.hdf5')
        pred = model.predict(X_test, batch_size=4, verbose=1)
        ...
        for slices in range(pred.shape[0]):
            ...
            for i in range(pred.shape[1]):
                for j in range(pred.shape[2]):
                    pred1[slices, i, j, 0] = np.argmax(pred[slices, i, j, :])
        print(pred1.shape)
        np.save('./VGG2/VGG16_tfcv5_1.npy', pred1)
...
class VGG3():
    ...
    def train(self):
        ...
        model.compile(optimizer=adam, loss='categorical_crossentropy',
                      metrics=['accuracy', self.dice_comp, self.dice_core, self.dice_en])  # adam 0.001 SGD 0.0001 SGD 0.00001
        checkpointer = ModelCheckpoint(filepath='../weights/VGG/3/VGG16_tfcv5.{epoch:02d}-{val_loss:.4f}.hdf5',
                                       monitor='val_loss', verbose=1)
        hist = model.fit(X_train, Y_train, epochs=70, validation_data=(X_test, Y_test), batch_size=10, shuffle=True,
                         callbacks=[checkpointer, change_lr])
    ...
    def test(self):
        ...
        print(X_test.shape)
        model = self.get_model()
        model.load_weights('./VGG3/weights/VGG16_tfcv5.69-0.0231.hdf5')
        pred = model.predict(X_test, batch_size=4, verbose=1)
        ...
        for slices in range(pred.shape[0]):
            ...
            for i in range(pred.shape[1]):
                for j in range(pred.shape[2]):
                    pred1[slices, i, j, 0] = np.argmax(pred[slices, i, j, :])
        print(pred1.shape)
        np.save('./VGG3/VGG16_tfcv5_1.npy', pred1)
...
class VGG4():
    ...
    def train(self):
        ...
        model.compile(optimizer=adam, loss='categorical_crossentropy',
                      metrics=['accuracy', self.dice_comp, self.dice_core, self.dice_en])  # adam 0.001 SGD 0.0001 SGD 0.00001
        checkpointer = ModelCheckpoint(filepath='../weights/VGG/4/VGG16_tfcv5.{epoch:02d}-{val_loss:.4f}.hdf5',
                                       monitor='val_loss', verbose=1)
        hist = model.fit(X_train, Y_train, epochs=70, validation_data=(X_test, Y_test), batch_size=10, shuffle=True,
                         callbacks=[checkpointer, change_lr])
    ...
    def test(self):
        ...
        print(X_test.shape)
        model = self.get_model()
        model.load_weights('./VGG4/weights/VGG16_tfcv5.69-0.0231.hdf5')
        pred = model.predict(X_test, batch_size=4, verbose=1)
        ...
        for slices in range(pred.shape[0]):
            ...
            for i in range(pred.shape[1]):
                for j in range(pred.shape[2]):
                    pred1[slices, i, j, 0] = np.argmax(pred[slices, i, j, :])
        print(pred1.shape)
        np.save('./VGG4/VGG16_tfcv5_1.npy', pred1)
